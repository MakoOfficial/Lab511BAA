...
if __name__ == '__main__':
    ...
    # 定义数据集路径
    train_image_dir = '../../../autodl-tmp/data/TSRS_RSNA-Articular-Surface/train'
    train_label_dir = '../../../autodl-tmp/data/TSRS_RSNA-Articular-Surface/train_labels_gray'

    test_image_dir = '../../../autodl-tmp/data/TSRS_RSNA-Articular-Surface/val'
    test_label_dir = '../../../autodl-tmp/data/TSRS_RSNA-Articular-Surface/val_labels_gray'
    batch_size = 16
    # 装载数据，设定模型
    ...
    model_save_path = '../../../autodl-tmp/UnetCheckPoint'
    os.makedirs(model_save_path, exist_ok=True)
    model_save_name = "unet_segmentation_Attn_Unet_RSNA_256_Full_50epoch_3090_NoRC_16_NoDL.pth"
    num_iter = 1800
    dataLen = trainDataset.__len__()
    per_iter = dataLen // batch_size
    num_epoch = num_iter // per_iter
