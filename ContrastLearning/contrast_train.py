...
flags['model_name'] = 'Contrast_WCL_IN_CBAM_AVGPool_AdaA_GenderPlus_Full_1_11_96_Pretrain_NoBN_MSE_Scale_ViT_ValidSave_1_18'
flags['node'] = '将池化操作改为ViT，并将验证集改回来，优化ViT，参考官方的方法，但是没改PatchEmbed，没加入位置编码'
flags['seed'] = 1
