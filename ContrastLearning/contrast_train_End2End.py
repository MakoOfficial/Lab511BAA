...
from utils import L1_penalty, log_contrast_losses_to_csv_End2End, save_attn_KD, save_contrast_attn_6Stage, attn_offset_kl_loss_firstStage

from ContrastLearning.contrast_model import get_student_contrast_model, get_student_contrast_model_OnlyKD, get_student_contrast_model_End2End
...
def train_fn(train_loader, loss_fn, triple_fn, optimizer):
    ...
    for idx, data in enumerate(train_loader):
        ...
        total_loss = loss + penalty_loss + flags['attn_ratio'] * train_attn_loss
        if triple_loss_0 == 0:
        ...
        print(f"batch_loss: {batch_loss}, AttnLoss: {train_attn_loss.item()}, WCL0: {triple_loss_0.item()}, WCL1: {triple_loss_1.item()}, "
        ...
        total_attn_loss += train_attn_loss.item()

    return training_loss, total_attn_loss, total_triple_loss_0, total_triple_loss_1, total_size
...
def training_start(flags):
    ...
    for epoch in range(flags['num_epochs']):
        ...
        training_loss, training_attn_loss, training_triple_loss_0, training_triple_loss_1, total_size = train_fn(train_loader, loss_fn, triple_fn, optimizer)
        ...
        mean_attn_loss = training_attn_loss / total_size
        ...
        log_contrast_losses_to_csv_End2End(training_mean_loss, mean_attn_loss, mean_triple_loss_0,
...
if __name__ == "__main__":
    ...
    contrast_model = get_student_contrast_model_End2End().cuda()
    #   load data setting
