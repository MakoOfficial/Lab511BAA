...
if __name__ == "__main__":
    ckpt_path = "../Contrast_Output/Contrast_WCL_IN_CBAM_AVGPool_AdaA_DropLast_pretrained_12-26/Contrast_WCL_IN_CBAM_AVGPool_AdaA_DropLast_pretrained_12-26.bin"
    # ckpt_path = "../KD_All_Output/KD_modify_firstConv_RandomCrop/KD_modify_firstConv_RandomCrop.bin"
    ckpt_dir = os.path.dirname(ckpt_path)
    save_path = os.path.join(ckpt_dir, 'manifold_All')
    ...
    # valid_csv = os.path.join("../Contrast_Output/Contrast_WCL_IN_CBAM_AVGPool_AdaA_DropLast_pretrained_12-26/Contrast_minus3.csv")
