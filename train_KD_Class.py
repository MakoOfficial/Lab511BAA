...
from Student.student_classifier import get_student_class, get_student_gate_class
...
flags['save_path'] = '../../autodl-tmp/KD_All_Output_3090_Class'
flags['node'] = '训练蒸馏模块，采用分类'
flags['model_name'] = 'KD_Class_All_1_10'
flags['seed'] = 1
...
if __name__ == "__main__":
    ...
    student_model = get_student_class().cuda()
    #   load data setting
